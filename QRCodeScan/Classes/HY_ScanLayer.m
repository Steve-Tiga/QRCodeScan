...
@interface HY_ScanLayer ()<CAAnimationDelegate>
...
- (void)updateFocus:(CGRect)focusRect {
    self.focusRect = focusRect;
    self.lineAnimateDuration = focusRect.size.width/focusRect.size.height > 1 ? 1.5 : 2.0;
}
